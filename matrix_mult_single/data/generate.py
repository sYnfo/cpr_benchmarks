...
def generate(m, k, n):
    ...
    with Timer() as t:
        ...
        B = 100*np.random.rand(k, n).astype(np.float64)
    ...
    with Timer() as t:
        ...
        np.array([m, k, n], dtype=np.int).tofile(dir_path + '/meta.bin')
